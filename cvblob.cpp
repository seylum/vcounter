...
namespace cvb
{
  ...
  void cvFilterByArea(CvBlobs &blobs, unsigned int minArea, unsigned int maxArea)
  {
    ...
    //tambah
    //ofstream blobsOfile("blobsArea.txt", ios::app);
    //ofstream blobOfile("blobArea.txt", ios::app);
    ...
    while(it!=blobs.end())
    {
      ...
      //tambah
      std::cout << "blob centroid x, y :" << blob->centroid.x << " , " << blob->centroid.y << std::endl; // print the area
      std::cout << "blob label, area :" << blob->label << " , " << blob->area << std::endl; // print the area
      //blobsOfile << blob->label << "," << blob->centroid.x << "," << blob->centroid.y << ","<< blob->area << endl;
    ...
    blobs.erase(tmp);
          ...
          //tambah
          //blobOfile << blob->label << "," << blob->centroid.x << "," << blob->centroid.y << ","<< blob->area << endl;
    ++it;
      }
    }
  }
